              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildLogo(),
                    const SizedBox(height: AppSpacing.lg),
                    _buildNavItem(0, Icons.wb_sunny_outlined, 'Briefing'),
                    _buildNavItem(1, Icons.inbox_outlined, 'Inbox'),
                    _buildNavItem(2, Icons.science_outlined, 'Research'),
                    _buildNavItem(3, Icons.folder_outlined, 'Projects'),
                    _buildNavItem(4, Icons.calendar_today_outlined, 'Calendar'),
